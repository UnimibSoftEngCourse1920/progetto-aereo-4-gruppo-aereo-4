...
class ClienteDB extends AbstractDB
{
    ...
    public function generateGetQuery($OID, $class)
    {
        //Ridefinendo il metodo, qui, forzo ad usare la tabella Cliente anche quando si tratta di cliente fedelta
        //NB: la tabella clienteFedelta non esiste
        //TODO collassare Cliente in una sola classe (come sul db), così evito queste porcate
        return parent::generateGetQuery($OID, "Cliente"); // TODO: Change the autogenerated stub
    }
